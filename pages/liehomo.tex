\newcommand{\homohelptext}{
  \section{Homomorphism help here!}
  ...
  \begin{itemize}
    ...
    \item Consider the \trace\ map
      $\tracemath\colon\mathsf{gl}(n,\mathbb{F})\longrightarrow\mathbb{F}$
      which takes a matrix to its \trace.  This is a Lie algebra
      homomorphism as both sides of the definition are zero:
